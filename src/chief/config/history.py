...
def restore_newest(
    ...
    if config_path.is_file():
        ...
        failed_copy.write_bytes(current)
        failed_copy.chmod(config_path.stat().st_mode & 0o777)
    config_path.write_bytes(newest.read_bytes())
    config_path.chmod(newest.stat().st_mode & 0o777)
    return newest
